    ...
    axios({
      ...
      .then((res) => {
        this.setState({
          ...
          status: true,
          statusMessage:
            " Qoute was sent successfully. Please expect a reply from us",
        });
      })
      .catch((e) => {
        this.setState({
        ...
        <div>
          ...
          <form className="pt-4" onSubmit={this.submitQuote}>
            ...
            <div className="form-group pt-3 quote-form">
              <label htmlFor="product-desc">What do you want to print ?</label>
              <br />
              <small>
                  ...
                  <div className="form-check">
                    <input
                      ...
                      onChange={(e) =>
                        e.target.checked &&
                        this.setState({
                          designStatus: "user wants us to handle design",
                        })
                      }
                    />
                    <label className="form-check-label" htmlFor="nodesign">
                      No, I want your team to design for me.
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div className="form-group pt-3 quote-form">
              ...
              <br />
              <small>
                Please provide your location, so we can make your delivery
                seamless.
              </small>
              <textarea
                id="address"
            ...
            <button type="submit" className="btn bg-brand text-light">
              Submit
            </button>
          </form>
